    ...
    <>
      ...
      >
        ...
        <Slide direction="right" triggerOnce>
          <p className="paragraph text-center mt-8">
            Наша команда всегда готова обсудить с Вами возможности
            сотрудничества и ответить на все Ваши вопросы. Не стесняйтесь
            связаться с нами – мы здесь, чтобы помочь Вам воплотить Ваши
            строительные и архитектурные идеи в реальность!
          </p>
        </Slide>
        <form
      ...
      >
        ...
        <p className="paragraph text-center w-[60%] mt-8">
          Наша команда всегда готова обсудить с Вами возможности сотрудничества
          и ответить на все Ваши вопросы. Не стесняйтесь связаться с нами – мы
          здесь, чтобы помочь Вам воплотить Ваши строительные и архитектурные
          идеи в реальность!
        </p>
        <form
          className="form flex flex-col items-center mt-8 mb-16"
